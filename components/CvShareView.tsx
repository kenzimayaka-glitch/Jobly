...
export function CvShareView({ token }: { token:string }) {
  ...
  return <main className="min-h-[100dvh] bg-[#F5F7FA] pb-10 text-[#0B2447]">
    <header className="sticky top-0 z-20 border-b border-slate-200/80 bg-white/90 px-4 py-3 backdrop-blur-xl"><div className="mx-auto flex max-w-5xl items-center justify-between"><div className="font-black tracking-tight"><span className="text-[#174EA6]">JOB</span><span className="text-[#FFE135]">LY</span></div><a href="/cv" className="rounded-full border border-slate-200 px-3 py-2 text-[10px] font-black uppercase tracking-wider">Télécharger Jobly</a></div></header>
